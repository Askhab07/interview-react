  ...
  return (
    <nav className='fixed bottom-0 bg-white w-full text-xs border-t-2 h-20'>
      <ul className='flex justify-between items-center h-16'>
        ...
        <li><Link className='flex flex-col gap-1 items-center w-20' to='/education'><AcademicCapIcon className='size-6 text-violet-500'/>Обучение</Link></li>
        <li><Link className='flex flex-col gap-1 items-center w-20' to='/inter'><CommandLineIcon className='size-6 text-violet-500'/>Собеседование</Link></li>
